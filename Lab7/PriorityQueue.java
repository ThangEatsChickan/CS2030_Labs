...
public class PriorityQueue<T> {
  ...
  public PriorityQueue(java.util.PriorityQueue<T> clonedPQ) {
	pq = new java.util.PriorityQueue<>(clonedPQ);
  }
...
/**
  ...
  public PriorityQueue<T> add(T object) {
	java.util.PriorityQueue<T> clonedPQ = new java.util.PriorityQueue<>(this.pq);
    clonedPQ.add(object);
    return new PriorityQueue<T>(clonedPQ);
  }
  /**
   ...
   **/
  //public Pair<Optional<T>, PriorityQueue<T>> poll() { //clone pq
    public Pair<Optional<T>, PriorityQueue<T>> poll() {
      java.util.PriorityQueue<T> clonedPQ = new java.util.PriorityQueue<T>(this.pq);
      T t = clonedPQ.poll();
      Optional <T> opt = Optional.ofNullable(t);
      return Pair.of(opt, new PriorityQueue<T>(clonedPQ));
  }
}
